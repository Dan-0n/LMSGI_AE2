# Actividad Lenguajes de Marcas y Sistemas de Gestión de Información
Creación de una estructura de base de datos en XML que permita almacenar los datos de una biblioteca en la red con las siguientes características:
...
Además, se añade un DTD y XSD que permite validar el documento.
